...
static int test_known_vectors(void)
{
     ...
     * 
     * TODO: After running on reference platform, fill in expected values
     * and uncomment the checks below.
     */
    ...
    /*
     * Uncomment and fill in once reference values are established:
     * if (v0 != 0xXXXXXXXX) return 0;
     * if (v1 != 0xXXXXXXXX) return 0;
     * ...
     */
